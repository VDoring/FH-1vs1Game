...
void player_AttackNum_4_None() {
	printf("베지 못했습니다.\n");
}

void player_AttackNum_4_Normal() {
	printf("베었습니다.\n");
	Damage = Player_ATK / 2; //플레이어 공격력 나누기 2
	Damage -= Monster1_DEF / 3; //데미지에서 몬스터 방어력 나누기 3한만큼 빼기
}

void player_AttackNum_4_Critical() {
	printf("제대로 베었습니다.\n");
